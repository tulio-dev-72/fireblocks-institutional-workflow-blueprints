...
Also creates workflow tables with **role-scoped RLS** aligned to app RBAC (`analyst`, `treasury_manager`, `admin`). Re-run `supabase/schema.sql` in the SQL Editor after pulling policy updates.
